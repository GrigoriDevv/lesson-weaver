...
const Slide = styled.div`
  ...
  padding: 1.5rem;
  h3 { color: #a78bfa; font-size: 1.125rem; margin: 0 0 0.75rem 0; }
  p { color: #cbd5e1; font-size: 0.9rem; line-height: 1.6; margin: 0; }
  ul { margin: 0.75rem 0 0 0; padding-left: 1.25rem; color: #94a3b8; li { margin-bottom: 0.25rem; } }
`;
...
const ActionButton = styled.button<{ $primary?: boolean }>`
  ...
  ${({ $primary }) =>
    ...
    border: none;
    color: white;
    &:hover { transform: translateY(-2px); box-shadow: 0 4px 12px rgba(139, 92, 246, 0.4); }
  `
      : `
    background: rgba(255, 255, 255, 0.1);
    border: 1px solid rgba(139, 92, 246, 0.3);
    ...
    <Overlay onClick={onClose}>
      <Modal onClick={(e) => e.stopPropagation()}>
        ...
        <ModalFooter>
          ...
          <ActionButton $primary onClick={onDownloadPptx}>
            <Download size={16} />
            Baixar .pptx
          </ActionButton>
        </ModalFooter>
